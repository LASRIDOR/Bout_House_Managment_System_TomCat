...
public class MemberFieldsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            fields.put(MemberFieldType.EMAIL.getNameOfField(), allFieldsOfInstance.get(MemberFieldType.EMAIL));
            fields.put(MemberFieldType.PASSWORD.getNameOfField(), allFieldsOfInstance.get(MemberFieldType.PASSWORD));
            fields.put(MemberFieldType.USERNAME.getNameOfField(), allFieldsOfInstance.get(MemberFieldType.USERNAME));
            fields.put(MemberFieldType.PHONE_NUMBER.getNameOfField(), allFieldsOfInstance.get(MemberFieldType.PHONE_NUMBER));
