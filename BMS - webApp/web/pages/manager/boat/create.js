...
const SERIAL_NUMBER_ID_KEY = "Serial NumberID"
const BOAT_NAME_ID_KEY = "Boat NameID"
const BOAT_TYPE_ID_KEY = "Boat Type: (1X/2-/2+/2X/2X+/4+/4-/4X+/4X/8X+/8+) (Narrow/Wide) (FlatWater/Coastal)\n" + "i.e. 2- Wide CoastalID"
