...
@WebServlet(name = "DeleteNotificationToAllMembers", urlPatterns = "/delete notification to all members")
public class DeleteNotificationToAllMembers extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        allMemberNotificationManager.deleteNotification(indexToDelete);
